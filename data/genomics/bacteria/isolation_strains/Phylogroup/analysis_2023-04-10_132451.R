...
# data loading, /mnt/d/These/30_dev/trash/ClermonTyping/analysis_2023-04-10_132451/analysis_2023-04-10_132451_phylogroups.txt will be replaced by the rightful name of the report as inputed in report_calling_func()
clermonT <- 
  read_delim("/mnt/d/These/30_dev/trash/ClermonTyping/analysis_2023-04-10_132451/analysis_2023-04-10_132451_phylogroups.txt", 
             "\t", escape_double = FALSE, col_names = c("file", "internal", "quadruplex", "supp", "phylogroup", "mash_file"),
             col_types = paste0(rep("c", 6), collapse = ""), 
             trim_ws = TRUE, 
             quoted_na = FALSE)

clermonT_out_dir <- dirname("/mnt/d/These/30_dev/trash/ClermonTyping/analysis_2023-04-10_132451/analysis_2023-04-10_132451_phylogroups.txt")
